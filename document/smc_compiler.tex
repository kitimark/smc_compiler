...
ในการทำงานของโปรแกรมจะแบ่งเป็น 2 ส่วนหลักๆ ก็คือ Conpiler และ simulator 
\begin{center}
    ...
    \begin{tikzpicture}[node distance = 3cm, auto]
        ...
        \node [block, right of=file] (Compiler) {Compiler};
        \node [block, right of=Compiler] (simulator) {simulator};
        \node[draw=none,fill=none,right of=simulator] (result) {result};
        
        % Draw edges
        \path [line] (file) -- (Compiler);
        \path [line] (Compiler) --  (simulator);
